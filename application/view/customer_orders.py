...
def change_order_menu():
    ...
    print()
    while True:
        choice = input("What would you like to change/insert (1-9)?: ")
...
def update_customer_order():
    ...
    match choice:
        case "1":
            ...
            if cars:
                car_models = print_customers_cars(cars, customer_controller.get_customer_by_id(order.customer_id))
