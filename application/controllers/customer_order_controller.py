...
def create_order_details(order_details):
    customer_order_repository.create_order_details(order_details)
...
def update_product(order_details, new_product_number):
    customer_order_repository.update_product(order_details, new_product_number)


def update_price(order_details, new_price):
    customer_order_repository.update_price(order_details, new_price)


def update_quantity(order_details, new_quantity):
    customer_order_repository.update_quantity(order_details, new_quantity)


def update_customer(order, new_customer_id):
    customer_order_repository.update_customer(order, new_customer_id)


def update_store(order, new_store_id):
    customer_order_repository.update_store(order, new_store_id)


def update_employee(order, new_employee_id):
    customer_order_repository.update_employee(order, new_employee_id)
